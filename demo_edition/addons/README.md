# Demo Governorate — Odoo 17 Supply Chain Custom Modules
## الديوان العام للمحافظة التجريبية — وحدات سلسلة التوريد المخصصة

**Vendor:** Enterprise Solutions Demo  
**Client:** Demo Governorate General Diwan  
...
cp -r demo_gov_sc_modules/* /opt/odoo/addons/

# Or if using a custom addons path:
cp -r demo_gov_sc_modules/* /opt/odoo/custom_addons/
```
