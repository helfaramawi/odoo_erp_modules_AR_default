...
class DemoGovVendorPenaltyAgentLog(models.Model):
    _name = 'demo_gov.vendor.penalty.agent.log'
    ...
    inspection_id = fields.Many2one('demo_gov.inspection.committee', string='محضر لجنة الفحص', index=True, ondelete='cascade')
    ...
    penalty_id = fields.Many2one('demo_gov.penalty', string='الجزاء الناتج', index=True)
    ...
    def create(self, vals_list):
        ...
        for vals in vals_list:
            if vals.get('name', 'جديد') == 'جديد':
                vals['name'] = seq.next_by_code('demo_gov.vendor.penalty.agent.log') or 'جديد'
    ...
    def action_open_inspection(self):
        ...
        return {
            ...
            'res_model': 'demo_gov.inspection.committee',
