...
class Daftar224(models.Model):
    ...
    daftar55_id = fields.Many2one('demo_gov.daftar55', string='مرجع دفتر 55', ondelete='restrict', index=True)
    ...
    def create_dual_entry_from_daftar55(self, daftar55_id):
        ...
        """
        rec55 = self.env['demo_gov.daftar55'].browse(daftar55_id)
    ...
    def action_print_daftar224(self):
        return self.env.ref('demo_gov_daftar224.action_report_daftar224_daily').report_action(self)
