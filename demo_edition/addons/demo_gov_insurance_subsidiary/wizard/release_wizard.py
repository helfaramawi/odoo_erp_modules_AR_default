...
class ReleaseWizard(models.TransientModel):
    _name = 'demo_gov.insurance.release.wizard'
    ...
    bank_guarantee_ids = fields.Many2many('demo_gov.bank.guarantee',
        string='خطابات الضمان')
    deposit_ids = fields.Many2many('demo_gov.insurance_deposit', relation='ins_deposit_release_wiz_rel',
        string='الإيداعات')
    ...
    def default_get(self, fields_list):
        ...
        if active_model == 'demo_gov.bank.guarantee':
            res['bank_guarantee_ids'] = [(6, 0, active_ids)]
        elif active_model == 'demo_gov.insurance_deposit':
