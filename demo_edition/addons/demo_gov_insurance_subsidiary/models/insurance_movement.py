...
class InsuranceMovement(models.Model):
    _name = 'demo_gov.insurance.movement'
    ...
    bank_guarantee_id = fields.Many2one('demo_gov.bank.guarantee',
        string='خطاب الضمان', ondelete='cascade', index=True)
    insurance_deposit_id = fields.Many2one('demo_gov.insurance_deposit',
    ...
    # ── ربط بفولية شهرية ────────────────────────────────────────────────────
    folio_id = fields.Many2one('demo_gov.insurance.folio',
