...
class DemoGovProcurementLegalCompliance(models.Model):
    _name = 'demo_gov.procurement.legal.compliance'
    ...
    def create(self, vals_list):
        ...
        for vals in vals_list:
            if vals.get('name', _('New')) == _('New'):
                vals['name'] = seq.next_by_code('demo_gov.procurement.legal.compliance') or _('New')
    ...
    def action_recheck(self):
        ...
        if rec.exists():
            self.env['demo_gov.procurement.legal.engine'].sudo().check_procurement_record(rec, self.stage)
