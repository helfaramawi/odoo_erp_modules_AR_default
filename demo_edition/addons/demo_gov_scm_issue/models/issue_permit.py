...
class StockIssuePermitLine(models.Model):
    ...
    fixed_asset_id = fields.Many2one('demo_gov.fixed.asset', string='أصل ثابت')
...
class StockIssueRegisterLine(models.Model):
    ...
    هذا النموذج منفصل تماماً عن دفتر 55 ع.ح (demo_gov.daftar55)
...
class StockIssuePermit(models.Model):
    ...
    commitment_id = fields.Many2one('demo_gov.commitment', string='الارتباط المرتبط')
    ...
    daftar55_id = fields.Many2one(
        'demo_gov.daftar55', string='دفتر 55 (قديم)',
    ...
    def action_create_journal_entry(self):
        """Placeholder — الميثود الحقيقية في demo_gov_stock_finance_bridge/bridge_engine.py"""
