...
class BudgetCommitment(models.Model):
        ...
        for vals in vals_list:
            if not vals.get('commitment_number'):
                vals['commitment_number'] = (
                    self.env['ir.sequence'].next_by_code('demo_gov.commitment') or '/')
    ...
    def action_print_commitment(self):
        return self.env.ref('demo_gov_commitment.action_report_commitment').report_action(self)
