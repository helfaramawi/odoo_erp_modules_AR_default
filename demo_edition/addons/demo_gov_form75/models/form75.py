...
class Form75Closing(models.Model):
    ...
    form69_ids       = fields.Many2many('demo_gov.form69', string='الحسبة اليومية المُدرجة')
    ...
    def action_print(self):
        return self.env.ref('demo_gov_form75.action_report_form75').report_action(self)
    ...
    def build_from_form69(self, fiscal_year, fiscal_period, period_type='monthly'):
        ...
        f69_recs = self.env['demo_gov.form69'].search(domain)
        if not f69_recs:
