...
class PortSaidReportWizard(models.TransientModel):
    ...
    def _get_daftar55_records(self):
        ...
        return self.env['demo_gov.daftar55'].search(domain, order='sequence_number asc')
    ...
    def _get_commitment_records(self):
        ...
        return self.env['demo_gov.commitment'].search(domain, order='commitment_number asc')
    ...
    def _get_daftar224_records(self):
        ...
        return self.env['demo_gov.daftar224'].search(domain, order='entry_date asc, sequence_in_day asc')
    ...
    def _get_budget_summary_data(self):
        plans = self.env['demo_gov.budget.plan'].search([
    ...
    def _get_budget_variance_data(self):
        return self.env['demo_gov.budget.plan'].search([
            ('fiscal_year', '=', int(self.fiscal_year)),
            ('state', 'in', ['approved', 'active', 'closed']),
        ])
    ...
    def action_print_report(self):
        ...
        template_map = {
            'daftar55_summary':   'demo_gov_reports.rpt_daftar55_summary',
            'daftar55_detail':    'demo_gov_reports.rpt_daftar55_detail',
            'daftar224_daily':    'demo_gov_reports.rpt_daftar224_daily',
            'deductions_summary': 'demo_gov_reports.rpt_deductions_summary',
            'monthly_expenditure':'demo_gov_reports.rpt_monthly_expenditure',
            'budget_execution':   'demo_gov_reports.rpt_budget_execution',
            'commitment_status':  'demo_gov_reports.rpt_commitment_status',
            'auction_results':    'demo_gov_reports.rpt_auction_results',
            'lease_collection':   'demo_gov_reports.rpt_lease_collection',
            'lease_overdue':      'demo_gov_reports.rpt_lease_overdue',
            'payment_methods':    'demo_gov_reports.rpt_payment_methods',
            'dept_expenditure':   'demo_gov_reports.rpt_dept_expenditure',
            'trial_balance':      'demo_gov_reports.rpt_trial_balance',
            'partner_ledger':     'demo_gov_reports.rpt_partner_ledger',
            'general_ledger':     'demo_gov_reports.rpt_general_ledger',
            'budget_summary':     'demo_gov_reports.rpt_budget_summary_gov',
            'budget_variance':    'demo_gov_reports.rpt_budget_variance',
            'budget_by_dept':     'demo_gov_reports.rpt_budget_by_dept',
            'aging_suppliers':    'demo_gov_reports.rpt_aging_suppliers',
            'aging_customers':    'demo_gov_reports.rpt_aging_customers',
            'cash_bank_movement': 'demo_gov_reports.rpt_cash_bank',
            'advances_register':  'demo_gov_reports.rpt_advances_register_gov',
            'guarantees_register':'demo_gov_reports.rpt_guarantees_register_gov',
            'stock_valuation':    'demo_gov_reports.rpt_stock_valuation_gov',
            'chart_of_accounts':  'demo_gov_reports.rpt_chart_of_accounts_template',
        }
