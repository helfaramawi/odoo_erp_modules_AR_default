...
class DemoGovConflictInterestAlert(models.Model):
    _name = 'demo_gov.conflict.interest.alert'
    ...
    def create(self, vals_list):
        for vals in vals_list:
            if vals.get('name', _('New')) == _('New'):
                vals['name'] = self.env['ir.sequence'].sudo().next_by_code('demo_gov.conflict.interest.alert') or _('New')
