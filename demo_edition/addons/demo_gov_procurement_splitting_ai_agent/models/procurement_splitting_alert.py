...
class DemoGovProcurementSplittingAlert(models.Model):
    _name = 'demo_gov.procurement.splitting.alert'
    ...
    def create(self, vals_list):
        ...
        for vals in vals_list:
            if vals.get('name', _('New')) == _('New'):
                vals['name'] = seq.next_by_code('demo_gov.procurement.splitting.alert') or _('New')
