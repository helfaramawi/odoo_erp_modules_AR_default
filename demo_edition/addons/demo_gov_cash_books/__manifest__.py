# -*- coding: utf-8 -*-
{
    ...
    'description': """
        ...
        - الدفتر 4: نموذج مستقل (demo_gov.payment_order) بدورة حياة كاملة
          (received → registered → cleared → posted).
        - الدفتر 5: نموذج مستقل (demo_gov.surety) — كفالات نقدية/موظفين.

        الشيكات تُسجَّل في نموذج demo_gov.cheque الأساسي (lightweight) في هذه الوحدة،
        ليُمدَّد في C-FM-12 demo_gov_cheques (الدفتر 56).
