...
class FixedAsset(models.Model):
    ...
    يتكامل مع: l10n_eg_custody | demo_gov_daftar55 | account.move
    """
    _name = 'demo_gov.fixed.asset'
    ...
    category_id = fields.Many2one(
        'demo_gov.asset.category', string='الفئة',
    ...
    daftar55_id = fields.Many2one(
        'demo_gov.daftar55', string='مرجع دفتر 55 ع.ح',
        help='الصرف المالي المرتبط بالاقتناء من دفتر 55',
        tracking=True
    )
    commitment_id = fields.Many2one(
        'demo_gov.commitment', string='الارتباط الميزاني',
    ...
    depreciation_line_ids = fields.One2many(
        'demo_gov.asset.depreciation.line', 'asset_id',
        string='جدول الإهلاك'
    )
    ...
    def _generate_depreciation_schedule(self):
        ...
        if lines_to_create:
            self.env['demo_gov.asset.depreciation.line'].create(lines_to_create)
    ...
    def action_post_all_pending_depreciation(self):
        ...
        today = date.today()
        lines = self.env['demo_gov.asset.depreciation.line'].search([
    ...
    def action_view_depreciation(self):
        ...
        return {
            ...
            'res_model': 'demo_gov.asset.depreciation.line',
            'view_mode': 'list',
    ...
    def action_open_disposal_wizard(self):
        ...
        return {
            ...
            'res_model': 'demo_gov.asset.disposal',
            'view_mode': 'form',
            'target': 'new',
            'context': {
