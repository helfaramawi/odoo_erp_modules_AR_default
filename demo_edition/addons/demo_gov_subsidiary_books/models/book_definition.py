...
class SubsidiaryBookDefinition(models.Model):
    _name = 'demo_gov.subsidiary.book'
    ...
    account_classification_ids = fields.Many2many(
        'demo_gov.subsidiary.account.classification',
    ...
    def action_open_folios(self):
        ...
        return {
            ...
            'res_model': 'demo_gov.subsidiary.folio',
            'view_mode': 'list,form',
    ...
    def action_print_book(self):
        ...
        return {
            ...
            'res_model': 'demo_gov.subsidiary.print.wizard',
            'view_mode': 'form',
            'target': 'new',
            'context': {'default_book_id': self.id},
        }
        ...
        for rec in recs:
            if not rec.sequence_id:
                rec.sequence_id = self.env['ir.sequence'].create({
                    ...
                    'code': 'demo_gov.subsidiary.book.%s' % rec.code.lower(),
