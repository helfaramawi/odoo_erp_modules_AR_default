...
يولّد بيانات اختبار واقعية لبيئة UAT المحافظة التجريبية
"""
import logging
...
VENDORS = [
    ...
    'شركة المحافظة التجريبية للخدمات العامة',
...
class UATDataGenerator(models.AbstractModel):
    ...
    def _generate_uat_scenarios(self):
        ...
        scenarios = [
            ...
            ('BDG-007', 'لوحة قيادة الموازنة - رسم بياني', 'budget', 'الموازنة',
             ...
             'لوحة قيادة الموازنة - المحافظة التجريبية',
             'مدير مالي', 'pending'),
            ...
            ('RPT-001', 'تقرير تنفيذ الموازنة', 'report', 'التقارير',
             ...
             'وحدة التقارير - المحافظة التجريبية',
             'مدير مالي', 'pending'),
    ...
    def _generate_auctions(self):
        ...
        scenarios = [
            ...
            {
                'description': f'{UAT_BATCH} - مزاد بيع عقار — أرض المحافظة التجريبية الجديدة',
                'auction_type': 'sale',
                'sale_type': 'property',
                'tender_method': 'public',
