...
class ResConfigSettings(models.TransientModel):
    ...
    commitment_agent_notify_user_id = fields.Many2one(
        ...
        config_parameter='demo_gov_commitment_ai_agent.notify_user_id',
    )
