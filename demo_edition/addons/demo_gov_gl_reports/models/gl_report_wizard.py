...
class GlReportWizard(models.TransientModel):
    ...
    """
    _name = 'demo_gov.gl.report.wizard'
    ...
    def action_print(self):
        report_map = {
            'trial_balance':  'demo_gov_gl_reports.rpt_trial_balance',
            'partner_ledger': 'demo_gov_gl_reports.rpt_partner_ledger',
            'general_ledger': 'demo_gov_gl_reports.rpt_general_ledger',
            'chart_of_accounts': 'demo_gov_gl_reports.rpt_chart_of_accounts',
        }
