...
DEMO_GOV_PREFIXES = [
    'demo_gov_gl_reports', 'demo_gov_acct_reports',
    'demo_gov_daftar55', 'demo_gov_daftar224',
    'demo_gov_form69', 'demo_gov_form75',
    'demo_gov_commitment', 'demo_gov_dossier',
    'demo_gov_scm_requisition', 'demo_gov_scm_warehouse',
    'demo_gov_fixed_assets', 'l10n_eg_auction',
    'c3_aging_report', 'demo_gov_budget_planning',
    'demo_gov_reports',
]
...
class IrActionsReport(models.Model):
    ...
    def _render_qweb_pdf(self, report_ref, res_ids=None, data=None):
        ...
        is_demo_gov = any(report_name.startswith(p) for p in DEMO_GOV_PREFIXES)
        is_form50 = 'form50' in report_name
        if is_demo_gov and not is_form50:
            try:
