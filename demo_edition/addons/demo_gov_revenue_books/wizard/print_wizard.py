...
class RevenuePrintWizard(models.TransientModel):
    _name = 'demo_gov.revenue.print.wizard'
    _description = 'ساحر طباعة دفاتر الإيرادات/المصروفات'

    book_id = fields.Many2one('demo_gov.revenue.book',
    ...
    def action_print(self):
        self.ensure_one()
        Folio = self.env['demo_gov.revenue.folio']
        domain = [
        ...
        action_xmlid = {
            'form10': 'demo_gov_revenue_books.action_report_form10',
            'form81': 'demo_gov_revenue_books.action_report_form81',
