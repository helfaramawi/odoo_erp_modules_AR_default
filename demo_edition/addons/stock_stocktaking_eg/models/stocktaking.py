...
class StocktakingSession(models.Model):
    ...
    def action_print_form4(self):
        return self.env.ref('stock_stocktaking_eg.action_report_form4_writeoff').report_action(self)

    def action_print_form5(self):
        return self.env.ref('stock_stocktaking_eg.action_report_form5_daily').report_action(self)

    def action_print_form8(self):
        return self.env.ref('stock_stocktaking_eg.action_report_form8_return').report_action(self)

    def action_print_form9(self):
        return self.env.ref('stock_stocktaking_eg.action_report_form9_damaged').report_action(self)

    def action_print_stock_inventory(self):
        return self.env.ref('stock_stocktaking_eg.action_report_stock_inventory').report_action(self)
