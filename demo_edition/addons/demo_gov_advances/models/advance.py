...
class GovernmentAdvance(models.Model):
    ...
    يتكامل مع: account.move | demo_gov_daftar55 | demo_gov_commitment
    """
    ...
    daftar55_id = fields.Many2one(
        'demo_gov.daftar55', string='مرجع دفتر 55 (صرف السلفة)',
    )
    settlement_daftar55_id = fields.Many2one(
        'demo_gov.daftar55', string='مرجع دفتر 55 (التسوية)',
    )
    dossier_id = fields.Many2one(
        'demo_gov.dossier', string='الاضبارة المرتبطة',
    )
