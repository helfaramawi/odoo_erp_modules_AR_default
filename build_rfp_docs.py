...
def build_arabic(path):
    ...
    add_heading(doc, '2.2 الدفاتر المساعدة الحكومية (8 دفاتر)', 2)
...
def build_english(path):
    ...
    T(['Module', 'Description', 'Priority'], [
        ...
        ['Subsidiary Books (8 books)','Forms 29/39/71 — legal sequential numbering, monthly carry-forward','Mandatory'],
