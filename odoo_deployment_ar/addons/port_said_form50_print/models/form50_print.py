...
class Form50PrintLayer(models.Model):
    ...
    def _form50_positions(self):
        ...
        return {
            ...
            # ── الإقرار ────────────────────────────────────────────────────────
            # pixel underlines at y=1159px(66.1%): x=394-569(31.8-45.9%) & x=631-889(50.9-71.7%)
            53: (38.5, 65.5),   # في سنة           underline center=38.85% @ y=66.1%
            54: (60.9, 65.5),   # تاريخ العلامة    underline center=61.3%  @ y=66.1%

            # ── توقيعات قسم ج ─────────────────────────────────────────────────
            # pixel underlines at y=1256px(71.6%): x=59-255(4.8-20.6%) & x=478-746(38.5-60.2%)
            # pixel underlines at y=1281-1287px(73.0-73.4%): x=235-286(19-23.1%), x=402-449(32.4-36.2%), x=740-915(59.7-73.8%)
            55: (12.7, 71.0),   # مراقب الحسابات  underline center=12.7% @ y=71.6%
            56: (12.7, 73.0),   # رئيس الحسابات   below مراقب @ y=73.0%
            57: (49.4, 71.0),   # حساب البنك       underline center=49.4% @ y=71.6%
            58: (66.7, 73.0),   # بتاريخ           underline center=66.7% @ y=73.4%
            59: (21.0, 73.0),   # رئيس المصلحة    underline center=21.0% @ y=73.0%
            60: (91.4, 73.0),   # الشتمذ ج         right edge @ y=73.0%

            # ── قسم ج — سجل 55 والاعتمادات ───────────────────────────────────
            # pixel underline at y=1347px(76.8%): x=543-688(43.8-55.5%) center=49.6%
            ...
            61: (49.6, 76.5),   # قيد في سجل رقم 55  underline center=49.6% @ y=76.8%
            62: (21.9, 76.5),   # روجع في — سنة       @ y=76.5%
            63: (59.4, 76.5),   # روجع في — تاريخ     @ y=76.5%
            64: (29.1, 80.0),   # شيك — اسم المستفيد  underline center=29.1% @ y=80.4%
            65: (48.5, 81.8),   # يعتمد سحب           underline @ 48.5% y=82.0%
            66: (63.9, 81.8),   # وكيل الحسابات       underline @ 63.9% y=82.0%
            67: (84.5, 81.8),   # رئيس الحسابات       underline @ 84.5% y=82.0%
            68: (39.0, 85.2),   # في سنة (صرف)        underlines @ y=85.1-85.5%
            69: (24.4, 85.2),   # بمبلغ (رقم)          underlines @ y=85.1-85.5%

            # ── قسم د ─────────────────────────────────────────────────────────
            # pixel underlines at y=1524px(86.9%): 62.2%, 65.7-70.4%, 94.4%
            # pixel underlines at y=1553-1554px(88.5%): 46.1-49.4%, 41.1-44.5%
            70: (67.7, 86.7),   # تاريخ               underline @ 65.7-70.4% y=86.9%
            71: (47.8, 88.3),   # رقم القيد دفتر 224  underline center=47.8% @ y=88.5%
            72: (42.8, 88.3),   # إمضاء الكاتب        underline center=42.8% @ y=88.5%
            73: (20.5, 88.3),   # موظفي الشطب          @ y=88.3%
            74: (62.2, 86.7),   # سبب                  underline @ 62.2% y=86.9%
            75: (94.4, 86.7),   # رقم المستند           underline @ 94.4% y=86.9%
        }
