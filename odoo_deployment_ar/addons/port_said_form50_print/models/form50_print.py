...
class Form50PrintLayer(models.Model):
    ...
    def _form50_render_fields(self):
        ...
        wide_fields = {3,4,5,6,7,8,9,10,11,52,57,59,64,65,66,67,71,72,73,74,75}
        out = []
