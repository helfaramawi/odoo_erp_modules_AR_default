...
class Form50PrintLayer(models.Model):
    ...
    def _form50_positions(self):
        ...
        return {
            ...
            30: (26.5, 32.1),   # الكاتب المنوط  (v12: reverted to v9 y)
            31: (62.2, 32.1),   # تقييد رقم (z)   (v12: reverted to v9 x+y)
            32: (77.0, 32.1),   # التاريخ          (v12: reverted to v9 x+y)
            ...
            53: (38.5, 65.5),   # في سنة   (v12: reverted to v9 y)
            54: (58.2, 65.5),   # تاريخ العلامة  (v12: reverted to v9 x+y)
            ...
            55: (12.7, 71.0),   # مراقب الحسابات  (v12: reverted to v9 y)
            56: (12.7, 73.0),   # رئيس الحسابات   (v12: reverted to v9 y)
            57: (49.4, 71.0),   # حساب البنك       (v12: reverted to v9 x+y)
            58: (64.0, 73.0),   # بتاريخ           (v12: reverted to v9 x+y)
            59: (21.0, 73.0),   # رئيس المصلحة    (v12: reverted to v9 y)
            60: (88.7, 73.0),   # الشتمذ ج         (v12: reverted to v9 y)
            ...
            61: (47.0, 76.5),   # قيد في سجل رقم 55  (v12: reverted to v9 y)
            62: (21.9, 76.5),   # روجع في — سنة       (v12: reverted to v9 y)
            63: (56.7, 76.5),   # روجع في — تاريخ     (v12: reverted to v9 y)
