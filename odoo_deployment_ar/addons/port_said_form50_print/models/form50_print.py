...
class Form50PrintLayer(models.Model):
    ...
    def _form50_positions(self):
        ...
        return {
            ...
            40: (68.44, 47.07),  41: (75.03, 47.07),  # إجمالي الأصل
            42: (68.44, 49.56),  43: (75.03, 49.56),  # دمغة عادية
            44: (68.44, 51.62),  45: (75.03, 51.62),  # دمغة إضافية
            46: (68.44, 53.57),  47: (75.03, 53.57),  # دمغة نسبية
            48: (68.44, 55.61),  49: (75.04, 55.61),  # ضريبة الأرباح
