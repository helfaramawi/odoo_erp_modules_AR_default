...
class Form50PrintLayer(models.Model):
    ...
    def _form50_positions(self):
        ...
        return {
            ...
            # blank y=33.01%: clerk x=17.7-39.3%, reg x=54.4-79.4%; date blank y=32.73% x=83.7-87.2%
            30: (26.5, 33.01),  # الكاتب المنوط  (v11: y corrected to underline)
            31: (73.6, 33.01),  # تقييد رقم (z)   (v11: right-align in blank 54.4-79.4%, 9ch*0.65=5.8→79.4-5.8=73.6)
            32: (80.7, 32.73),  # التاريخ          (v11: right-align in blank 83.7-87.2%, 10ch*0.65=6.5→87.2-6.5=80.7)
            ...
            # blank y=66.13%: year x=31.9-45.9%(c=38.9%), date x=50.9-71.6%(c=61.3%)
            53: (38.5, 66.13),  # في سنة   (v11: y corrected)
            54: (65.1, 66.13),  # تاريخ العلامة  (v11: right-align 71.6-6.5=65.1)
            ...
            # blank y=71.61%: auditor x=4.8-20.6%(c=12.7%), bank x=38.5-60.2%(c=49.3%)
            # blank y=73.09%: رئيس المصلحة x=18.9-23.1%(c=21.0%)
            # blank y=73.38%: بتاريخ x=59.7-73.8%(c=66.7%)
            55: (12.7, 71.61),  # مراقب الحسابات  (v11: y corrected)
            56: (12.7, 73.09),  # رئيس الحسابات   (v11: y corrected)
            57: (52.4, 71.61),  # حساب البنك       (v11: right-align 60.2-12*0.65=52.4)
            58: (67.3, 73.38),  # بتاريخ           (v11: right-align 73.8-6.5=67.3)
            59: (21.0, 73.09),  # رئيس المصلحة    (v11: y corrected)
            60: (88.7, 73.09),  # الشتمذ ج         (v11: y corrected)
            ...
            # blank y=76.80%: سجل55 x=43.8-55.5%(c=49.6%); y=76.51%: year blanks x=56-62.8%
            61: (47.0, 76.80),  # قيد في سجل رقم 55  (v11: right-align 55.5-8.4=47.1)
            62: (21.9, 76.80),  # روجع في — سنة
            63: (56.7, 76.80),  # روجع في — تاريخ     (v11: y corrected)
