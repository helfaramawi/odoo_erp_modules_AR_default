...
class Form50PrintLayer(models.Model):
    ...
    def _form50_positions(self):
        ...
        return {
            ...
            12: (81.9, 15.7),  13: (75.5, 15.7),  14: (67.3, 15.7),  15: (60.9, 15.7),
            16: (81.9, 19.0),  17: (75.5, 19.0),  18: (67.3, 19.0),  19: (60.9, 19.0),
            20: (81.9, 22.3),  21: (75.5, 22.3),  22: (67.3, 22.3),  23: (60.9, 22.3),
            24: (81.9, 25.7),  25: (75.5, 25.7),  26: (67.3, 25.7),  27: (60.9, 25.7),
            28: (67.3, 28.5),  29: (60.9, 28.5),  # الجملة

            # ── قسم ب ─────────────────────────────────────────────────────────
            # data row y=547-578px center=562px(32.1%)
            30: (26.5, 32.1),   # الكاتب المنوط بالسجل
            31: (65.7, 32.1),   # تقييد في السجل رقم
            32: (79.7, 32.1),   # التاريخ

            # ── الاعتماد الإداري ──────────────────────────────────────────────
            # V-seps from pixel analysis (y=673-808):
            #   عدد المرفقات: center=95px(7.7%)
            #   بند: center=604px(48.7%)  فصل: center=644px(51.9%)
            #   فرع: center=666px(53.7%)  قسم: center=685px(55.2%)
            #   جنيه: cell between 915-957px center=936px(75.5%)
            #   قرش: cell between 973-1075px center=1024px(82.6%)
            # data row y=707-807px center=757px(43.2%)
            # إجمالي الأصل: y=807-843px center=825px(47.1%)
            33: ( 7.7, 43.2),   # عدد المرفقات
            34: (48.7, 43.2),   # بند
            35: (51.9, 43.2),   # فصل
            36: (53.7, 43.2),   # فرع/نوع
            37: (55.2, 43.2),   # قسم/باب
            38: (75.5, 43.2),   # إجمالي — جنيه
            39: (82.6, 43.2),   # إجمالي — قرش
            40: (75.5, 47.1),   # إجمالي الأصل — جنيه
            41: (82.6, 47.1),   # إجمالي الأصل — قرش

            # ── الاستقطاعات ───────────────────────────────────────────────────
            # V-seps (y=843-1007): 3 deduction types in 3 ROWS, 2 value columns
            #   Value columns: cell 811-915px (جنيه, wider, 104px) center=863px(69.6%)
            #                  cell 915-973px (قرش, narrower, 58px) center=944px(76.1%)
            # Row y-centers from left-side label bands:
            #   عادي:   dark band at y=886-899 → label center=892px(50.9%)
            #   إضافي:  dark band at y=910-923 → label center=916px(52.2%)
            #   نسبية:  dark band at y=939-945 → label center=942px(53.7%)
            # رسم الدمغة: separate row y=1007-1031 center=1019px(58.1%)
            42: (69.6, 50.9),   # دمغة عادية — جنيه
            43: (76.1, 50.9),   # دمغة عادية — قرش
            44: (69.6, 52.2),   # دمغة إضافية — جنيه
            45: (76.1, 52.2),   # دمغة إضافية — قرش
            46: (69.6, 53.7),   # دمغة نسبية — جنيه
            47: (76.1, 53.7),   # دمغة نسبية — قرش
            48: (69.6, 58.1),   # رسم الدمغة — جنيه  y=1007-1031 center=1019px(58.1%)
            49: (76.1, 58.1),   # رسم الدمغة — قرش

            # ── صافي القيمة والتفقيط ──────────────────────────────────────────
            # صافي row y=1031-1067px center=1049px(59.8%)
            # same value columns as deduction: جنيه=69.6%, قرش=76.1%
            50: (69.6, 59.8),   # صافي — جنيه
            51: (76.1, 59.8),   # صافي — قرش
            52: (26.7, 61.6),   # التفقيط — starts at right edge of text box (x=331px=26.7%)

            # ── الإقرار ────────────────────────────────────────────────────────
            # y=1159-1208px center=1183px(67.5%)
            53: (49.2, 67.5),   # في سنة
            54: (84.8, 67.5),   # تاريخ العلامة
