...
class Form50PrintLayer(models.Model):
    ...
    def _form50_positions(self):
        ...
        return {
            ...
            # أعمدة (right→left): رقم x≈82%, تاريخ x≈75.6%, جنيه x≈67.5%, قرش x≈60.9%
            # صفوف: بيانات الفواتير header y≈11.8%, column labels y≈13.1%,
            #   data area y=15.3%–29.5% → 4 rows each ~3.55% tall
            #   R1 center y≈17.0%, R2≈20.5%, R3≈24.0%, R4≈27.5%, جملة≈30.0%
            12: (82.0, 17.0),  13: (75.6, 17.0),  14: (67.5, 17.0),  15: (60.9, 17.0),
            16: (82.0, 20.5),  17: (75.6, 20.5),  18: (67.5, 20.5),  19: (60.9, 20.5),
            20: (82.0, 24.0),  21: (75.6, 24.0),  22: (67.5, 24.0),  23: (60.9, 24.0),
            24: (82.0, 27.5),  25: (75.6, 27.5),  26: (67.5, 27.5),  27: (60.9, 27.5),
            28: (67.5, 30.0),  29: (60.9, 30.0),  # الجملة

            # ── قسم ب ─────────────────────────────────────────────────────────
            # data row between y=517px(29.5%) and y=578px(33.0%), center≈32.0%
            30: (26.5, 32.2),   # الكاتب المنوط بالسجل
            31: (65.7, 32.2),   # تقييد في السجل رقم
            32: (79.7, 32.2),   # التاريخ

            # ── الاعتماد الإداري ──────────────────────────────────────────────
            # data row y≈705-807px center=43.1%: عدد مرفقات(7.7%), بند(48.8%),
            #   فصل(53.6%), فرع(58.2%), قسم(63.1%), جنيه(76.5%), قرش(81.5%)
            # قرش separator at x=78.5%→84.3%, center=81.5% (was wrongly at 91%)
            ...
            39: (81.5, 43.2),   # إجمالي — قرش  (fixed: was 91.0 = seal area)
            40: (76.5, 47.0),   # إجمالي الأصل — جنيه  y≈807-843px center=47.0%
            41: (81.5, 47.0),   # إجمالي الأصل — قرش  (fixed: was 91.0)

            # ── الاستقطاعات ───────────────────────────────────────────────────
            # data area y=877-956px (50-54.5%): header rows take y=843-877
            # data center≈52.5%; رسم الدمغة y=956-984px center≈55.3%
            42: (13.3, 52.5),   # دمغة عادية — جنيه
            43: (19.5, 52.5),   # دمغة عادية — قرش
            44: (34.0, 52.5),   # دمغة إضافية — جنيه
            45: (40.2, 52.5),   # دمغة إضافية — قرش
            46: (55.1, 52.5),   # دمغة نسبية — جنيه
            47: (59.7, 52.5),   # دمغة نسبية — قرش
            48: (19.0, 55.3),   # رسم الدمغة — جنيه  y=984-1006px center≈55.3%
            49: (37.3, 55.3),   # رسم الدمغة — قرش

            # ── صافي القيمة والتفقيط ──────────────────────────────────────────
            # صافي row y=1006-1067px center≈57.8%; التفقيط lines y≈1067-1128px center≈61.0%
            50: (61.3, 57.8),   # صافي — جنيه
            51: (36.9, 57.8),   # صافي — قرش
            52: ( 3.0, 61.0),   # التفقيط بالكلام (wide text — start from left edge)

            # ── الإقرار ────────────────────────────────────────────────────────
            # between التفقيط and y=1208px(68.9%) major line; center≈64.5%
            53: (49.2, 64.5),   # في سنة
            54: (84.8, 64.5),   # تاريخ العلامة
