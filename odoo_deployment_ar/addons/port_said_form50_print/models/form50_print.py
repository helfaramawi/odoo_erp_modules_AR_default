...
class Form50PrintLayer(models.Model):
    ...
    def _form50_positions(self):
        ...
        return {
            ...
            1:  (83.5,  3.8),   # رقم المسلسل
            2:  (83.5,  5.8),   # تاريخ الورود
            # ══ قسم أ — لوح يسار (المصلحة والطلب) ═════════════════════════
            3:  (28.0, 15.5),   # اسم المصلحة
            4:  (28.0, 17.8),   # القسم / الإدارة
            5:  (28.0, 20.2),   # المبلغ المستحق إلى
            6:  (28.0, 22.5),   # رقم الارتباط / بموجب
            # ══ طريقة الصرف ═════════════════════════════════════════════
            7:  ( 5.0, 24.8),   # صار مراجعته
            8:  (20.0, 26.8),   # إذن صرف — البنك
            9:  (20.0, 28.8),   # شيك على الشارج
            10: (20.0, 30.5),   # يسحب باسم
            11: ( 6.0, 33.5),   # ويرسل — العنوان
            # ══ جدول الفواتير — لوح يمين ════════════════════════════════
            12: (58.0, 16.5),  13: (63.8, 16.5),  14: (72.0, 16.5),  15: (80.0, 16.5),
            16: (58.0, 19.5),  17: (63.8, 19.5),  18: (72.0, 19.5),  19: (80.0, 19.5),
            20: (58.0, 22.5),  21: (63.8, 22.5),  22: (72.0, 22.5),  23: (80.0, 22.5),
            24: (58.0, 25.5),  25: (63.8, 25.5),  26: (72.0, 25.5),  27: (80.0, 25.5),
            # ══ الجملة ══════════════════════════════════════════════════
            28: (72.0, 28.8),   # الجملة - جنيه
            29: (80.0, 28.8),   # الجملة - قرش
            # ══ أسفل قسم أ ══════════════════════════════════════════════
            ...
            34: (46.5, 43.5),   # بند
            35: (53.5, 43.5),   # فصل
            36: (60.0, 43.5),   # فرع / نوع
            37: (66.5, 43.5),   # قسم / باب
            38: (73.5, 43.5),   # إجمالي - جنيه
            39: (81.0, 43.5),   # إجمالي - قرش
            # ══ جدول الاستقطاعات (جنيه | قرش) ══════════════════════════
            40: (65.0, 49.5),  41: (73.0, 49.5),   # إجمالي الأصل
            42: (65.0, 52.0),  43: (73.0, 52.0),   # دمغة عادية
            44: (65.0, 54.0),  45: (73.0, 54.0),   # دمغة إضافية
            46: (65.0, 56.0),  47: (73.0, 56.0),   # دمغة نسبية
            48: (65.0, 58.0),  49: (73.0, 58.0),   # ضريبة الأرباح
            50: (65.0, 61.5),  51: (73.0, 61.5),   # صافي القيمة
            # ══ التفقيط ═════════════════════════════════════════════════
