...
class Form50PrintLayer(models.Model):
    ...
    def _form50_positions(self):
        ...
        return {
            ...
            1:  (90.44,  9.66),  # رقم المسلسل
            2:  (90.44, 16.26),  # تاريخ الورود

            # ── يسار — بيانات المصلحة والمستفيد ─────────────────────────────
            3:  (20.56,  9.90),  # مصلحة
            4:  (20.56, 11.63),  # قسم
            5:  (20.56, 13.51),  # المبلغ المستحق
            6:  (20.56, 16.89),  # بموجب
            7:  ( 3.56, 18.62),  # صار مراجعته
            8:  (20.56, 20.35),  # إذن صرف
            9:  (20.56, 22.00),  # شيك
            10: (20.56, 25.45),  # يسحب باسم
            11: (20.56, 28.83),  # ويرسل
