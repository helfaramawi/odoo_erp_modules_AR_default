...
class Form50PrintLayer(models.Model):
    ...
    def _form50_positions(self):
        ...
        return {
            ...
            1:  (84.0,  2.2),   # رقم المسلسل
            2:  (84.5,  4.0),   # تاريخ الورود
            # ── قسم أ — بيانات المصلحة (لوح يسار) ─────────────────────────
            3:  (29.0,  8.0),   # اسم المصلحة
            4:  (29.0,  9.8),   # القسم / الإدارة
            5:  (29.0, 11.6),   # المبلغ المستحق إلى (vendor)
            6:  (29.0, 15.2),   # رقم الارتباط / بموجب
            # ── حقول طريقة الصرف ────────────────────────────────────────
            7:  ( 3.0, 17.3),   # صار مراجعته
            8:  (19.0, 20.0),   # إذن صرف على البنك  ← كان (15,18.8)
            9:  (19.0, 22.0),   # شيك على الشارج      ← كان (15,20.7)
            10: (19.0, 24.0),   # يسحب باسم           ← كان (15,18.8) مكرر!
            11: ( 6.0, 27.5),   # ويرسل — العنوان
            # ── جدول الفواتير (لوح يمين، أربعة صفوف) ─────────────────────
            12: (58.5, 14.5),  13: (64.2, 14.5),  14: (72.5, 14.5),  15: (80.5, 14.5),
            16: (58.5, 16.5),  17: (64.2, 16.5),  18: (72.5, 16.5),  19: (80.5, 16.5),
            20: (58.5, 18.5),  21: (64.2, 18.5),  22: (72.5, 18.5),  23: (80.5, 18.5),
            24: (58.5, 20.5),  25: (64.2, 20.5),  26: (72.5, 20.5),  27: (80.5, 20.5),
            # ── الجملة ──────────────────────────────────────────────────
            28: (72.5, 22.5),   # إجمالي - جنيه   ← كان (72.4, 28.8)
            29: (80.5, 22.5),   # إجمالي - قرش    ← كان (80.2, 28.8)
            # ── أسفل قسم أ ──────────────────────────────────────────────
            30: (51.0, 31.5),   # الكاتب المنوط
            31: (25.0, 31.5),   # تقييد سجل (ز)
            32: (88.0, 33.5),   # تاريخ الختم أ   ← كان x=97 (خارج الصفحة!)
            # ── عدد المرفقات ─────────────────────────────────────────────
            33: ( 7.5, 38.5),   # عدد المرفقات
            # ── جدول تصنيف الموازنة ────────────────────────────────────
            34: (47.5, 41.5),   # بند
            35: (54.0, 41.5),   # فصل
            36: (60.5, 41.5),   # فرع / نوع
            37: (67.0, 41.5),   # قسم / باب
            38: (74.5, 41.5),   # إجمالي - جنيه
            39: (81.5, 41.5),   # إجمالي - قرش
            # ── جدول الاستقطاعات (عمودا جنيه/قرش) ─────────────────────
            40: (65.5, 47.5),  41: (73.5, 47.5),   # إجمالي الأصل
            42: (65.5, 49.5),  43: (73.5, 49.5),   # دمغة عادية
            44: (65.5, 51.0),  45: (73.5, 51.0),   # دمغة إضافية
            46: (65.5, 52.5),  47: (73.5, 52.5),   # دمغة نسبية
            48: (65.5, 54.0),  49: (73.5, 54.0),   # ضريبة الأرباح
            50: (65.5, 56.5),  51: (73.5, 56.5),   # صافي القيمة
            # ── التفقيط ──────────────────────────────────────────────────
            52: (18.0, 58.5),   # الصافي بالكلام
            # ── إقرار / السنة المالية ────────────────────────────────────
            53: (38.0, 61.5),   # في سنة (إقرار)
            # ── توقيعات قسم ب ────────────────────────────────────────────
            54: (88.5, 59.5),   # تاريخ الختم ب
            55: ( 8.5, 61.5),   # مراقب الحسابات
            56: ( 8.5, 63.5),   # رئيس الحسابات
            57: (54.0, 67.0),   # رقم حساب البنك
            58: (33.5, 67.0),   # بتاريخ
            59: ( 8.5, 67.0),   # رئيس المصلحة
            # ── قسم ج — المراجعة ─────────────────────────────────────────
            60: (89.5, 72.0),   # تاريخ الختم ج
            61: (52.0, 72.5),   # قيد في سجل 55
            62: (43.0, 75.0),   # في سنة (روجع)
            63: (59.0, 74.5),   # تاريخ المراجعة
            64: (55.0, 77.0),   # اسم المستفيد (شيك)
            65: (50.0, 80.0),   # يعتمد سحب - المبلغ
            66: (76.0, 83.5),   # وكيل / مدير الحسابات
            67: (30.0, 82.5),   # رئيس الحسابات
            68: (43.0, 84.0),   # في سنة (صرف)
            69: (12.0, 84.5),   # بمبلغ (رقم)
            # ── قسم د — الدفع ─────────────────────────────────────────────
            70: (89.5, 87.5),   # تاريخ الختم د
            71: (40.0, 88.5),   # رقم قيد دفتر 224
            72: (12.0, 88.5),   # توقيع الكاتب المنوط
            73: (12.0, 92.0),   # توقيع موظفي الشطب
            74: (40.0, 95.5),   # رقم أمر الدفع
            75: (62.0, 95.5),   # اسم صاحب الشيك
        }
