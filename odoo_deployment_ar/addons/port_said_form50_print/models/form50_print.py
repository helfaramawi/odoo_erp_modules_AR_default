...
class Form50PrintLayer(models.Model):
    ...
    def _form50_positions(self):
        ...
        return {
            ...
            3:  (23.84, 10.00),  # اسم المصلحة
            4:  (23.84, 11.72),  # القسم / الإدارة
            5:  (23.84, 14.24),  # المبلغ المستحق إلى
            6:  (23.84, 17.76),  # رقم الارتباط / بموجب
            # ══ طريقة الصرف ═════════════════════════════════════════════
            7:  ( 5.85, 20.39),  # صار مراجعته
            8:  (18.87, 22.89),  # إذن صرف — البنك
            9:  (18.87, 26.41),  # شيك على الشارج
            10: (18.88, 28.95),  # يسحب باسم
            11: ( 4.84, 30.54),  # ويرسل — العنوان
