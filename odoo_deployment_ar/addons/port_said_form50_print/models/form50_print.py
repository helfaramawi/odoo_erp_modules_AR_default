...
class Form50PrintLayer(models.Model):
    ...
    def _form50_positions(self):
        ...
        return {
            ...
            48: (62.9, 56.2),   # رسم الدمغة — جنيه  y=957-1007 label=985px(56.2%)
            49: (58.2, 56.2),   # رسم الدمغة — قرش

            # ── صافي القيمة والتفقيط ──────────────────────────────────────────
            # صافي zone y=1044-1067px center=1055px(60.1%), label at y=1061(60.5%)
            # same value columns as deduction: جنيه=62.9%, قرش=58.2%
            50: (62.9, 60.1),   # صافي — جنيه
            51: (58.2, 60.1),   # صافي — قرش
            52: (26.7, 62.2),   # التفقيط — text at y=1090-1093 → center≈1092px(62.3%)
