...
class Form50PrintLayer(models.Model):
    ...
    def _form50_positions(self):
        ...
        return {
            ...
            # pixel scan x=2250: serial box y=7.4-10.5%, date box y=10.5-12.3%
            1:  (91.0,  9.4),   # رقم المسلسل
            2:  (91.0, 11.2),   # تاريخ الورود
            # ══ قسم أ — لوح يسار (المصلحة والطلب) ═════════════════════════
            # pixel scan x=200: row borders 10.5,12.2,14.0,17.4,20.9,22.6,26.0,29.5,31.2%
            3:  (25.0, 11.4),   # اسم المصلحة
            4:  (25.0, 13.1),   # القسم / الإدارة
            5:  (25.0, 15.7),   # المبلغ المستحق إلى
            6:  (25.0, 19.2),   # رقم الارتباط / بموجب
            # ══ طريقة الصرف ═════════════════════════════════════════════
            7:  ( 5.0, 21.8),   # صار مراجعته
            8:  (20.0, 24.3),   # إذن صرف — البنك
            9:  (20.0, 27.8),   # شيك على الشارج
            10: (20.0, 30.4),   # يسحب باسم
            11: ( 6.0, 32.0),   # ويرسل — العنوان
            # ══ جدول الفواتير — لوح يمين ════════════════════════════════
            # pixel scan y=560-630: col borders 58.4,63.2,71.3,79.4,84.1% → centers 60.8,67.3,75.4,81.75
            # pixel scan x=1450: row borders 12.9,18.4,21.4,24.4,28.9% → centers 15.7,19.9,22.9,26.7
            12: (60.8, 15.7),  13: (67.3, 15.7),  14: (75.4, 15.7),  15: (81.75, 15.7),
            16: (60.8, 19.9),  17: (67.3, 19.9),  18: (75.4, 19.9),  19: (81.75, 19.9),
            20: (60.8, 22.9),  21: (67.3, 22.9),  22: (75.4, 22.9),  23: (81.75, 22.9),
            24: (60.8, 26.7),  25: (67.3, 26.7),  26: (75.4, 26.7),  27: (81.75, 26.7),
            # ══ الجملة ══════════════════════════════════════════════════
            28: (75.4, 29.6),   # الجملة - جنيه
            29: (81.75, 29.6),  # الجملة - قرش
            # ══ أسفل قسم أ ══════════════════════════════════════════════
            30: (48.0, 34.0),   # الكاتب المنوط
            31: (22.0, 34.0),   # تقييد سجل (ز)
            32: (87.5, 35.5),   # تاريخ الختم أ
            # ══ عدد المرفقات ════════════════════════════════════════════
            33: ( 7.0, 40.5),   # عدد المرفقات
            # ══ جدول تصنيف الموازنة ══════════════════════════════════════
            # pixel scan y=1450: col borders 46.3,51.0,55.8,60.5,65.3,73.6,78.4% → centers 48.7,53.4,58.2,62.9,69.5,76.0
            34: (48.7, 43.2),   # بند
            35: (53.4, 43.2),   # فصل
            36: (58.2, 43.2),   # فرع / نوع
            37: (62.9, 43.2),   # قسم / باب
            38: (69.5, 43.2),   # إجمالي - جنيه
            39: (76.0, 43.2),   # إجمالي - قرش
            # ══ جدول الاستقطاعات (جنيه | قرش) ══════════════════════════
            # pixel scan y=1700: amounts cols share same structure → جنيه=69.5%, قرش=76.0%
            40: (69.5, 49.5),  41: (76.0, 49.5),   # إجمالي الأصل
            42: (69.5, 52.0),  43: (76.0, 52.0),   # دمغة عادية
            44: (69.5, 54.0),  45: (76.0, 54.0),   # دمغة إضافية
            46: (69.5, 56.0),  47: (76.0, 56.0),   # دمغة نسبية
            48: (69.5, 58.0),  49: (76.0, 58.0),   # ضريبة الأرباح
            50: (69.5, 61.5),  51: (76.0, 61.5),   # صافي القيمة
            # ══ التفقيط ═════════════════════════════════════════════════
            52: (16.0, 64.5),   # الصافي بالكلام
            # ══ سنة الإقرار ══════════════════════════════════════════════
            53: (37.0, 67.5),   # في سنة
            # ══ توقيعات قسم ب ════════════════════════════════════════════
            54: (87.5, 65.0),   # تاريخ الختم ب
            55: ( 8.0, 67.0),   # مراقب الحسابات
            56: ( 8.0, 69.5),   # رئيس الحسابات
            57: (53.0, 73.5),   # رقم حساب البنك
            58: (32.0, 73.5),   # بتاريخ
            59: ( 8.0, 73.5),   # رئيس المصلحة
            # ══ قسم ج — المراجعة ══════════════════════════════════════════
            60: (87.5, 78.0),   # تاريخ الختم ج
            61: (51.0, 78.5),   # قيد في سجل 55
            62: (42.0, 81.0),   # في سنة (روجع)
            63: (58.0, 80.5),   # تاريخ المراجعة
            64: (54.0, 83.5),   # اسم المستفيد — شيك
            65: (48.5, 86.5),   # يعتمد سحب — المبلغ
            66: (75.0, 89.5),   # وكيل / مدير الحسابات
            67: (29.0, 88.5),   # رئيس الحسابات
            68: (42.0, 90.0),   # في سنة (صرف)
            69: (11.5, 90.5),   # بمبلغ (رقم)
            # ══ قسم د — الدفع ═════════════════════════════════════════════
            70: (87.5, 93.5),   # تاريخ الختم د
            71: (39.5, 94.5),   # رقم قيد دفتر 224
            72: (11.5, 94.5),   # توقيع الكاتب المنوط
            73: (11.5, 97.0),   # توقيع موظفي الشطب
            74: (39.5, 98.5),   # رقم أمر الدفع
            75: (61.0, 98.5),   # اسم صاحب الشيك
        }
