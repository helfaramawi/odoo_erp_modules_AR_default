...
class Form50PrintLayer(models.Model):
    ...
    def _form50_positions(self):
        ...
        return {
            ...
            3:  (23.84,  9.30),  # اسم المصلحة
            4:  (23.84, 11.02),  # القسم / الإدارة
            5:  (19.84, 12.84),  # المبلغ المستحق إلى
            6:  (19.84, 16.36),  # رقم الارتباط / بموجب
            # ══ طريقة الصرف ═════════════════════════════════════════════
            7:  ( 5.85, 19.69),  # صار مراجعته
            8:  (18.87, 21.52),  # إذن صرف — البنك
            9:  (18.87, 25.04),  # شيك على الشارج
            10: (18.88, 28.25),  # يسحب باسم
            11: (23.89, 29.84),  # ويرسل — العنوان
            # ══ جدول الفواتير — لوح يمين ════════════════════════════════
            12: (59.74, 15.24),  13: (64.41, 15.24),  14: (74.47, 15.24),  15: (80.74, 15.24),
            16: (59.74, 19.44),  17: (64.41, 19.44),  18: (74.47, 19.44),  19: (80.75, 19.44),
            20: (59.73, 22.51),  21: (64.39, 22.51),  22: (74.46, 22.51),  23: (80.74, 22.51),
            24: (59.73, 26.29),  25: (64.41, 26.29),  26: (74.47, 26.29),  27: (80.73, 26.29),
            # ══ الجملة ══════════════════════════════════════════════════
            28: (74.47, 29.15),  # الجملة - جنيه
            29: (80.74, 29.15),  # الجملة - قرش
            # ══ أسفل قسم أ ══════════════════════════════════════════════
            30: (68.39, 31.91),  # الكاتب المنوط
            31: (25.63, 31.91),  # تقييد سجل (ز)
            ...
            40: (68.44, 46.56),  41: (75.03, 46.56),  # إجمالي الأصل
            42: (68.44, 48.71),  43: (75.03, 48.71),  # دمغة عادية
            44: (68.44, 50.26),  45: (75.03, 50.26),  # دمغة إضافية
            46: (68.44, 51.87),  47: (75.03, 51.87),  # دمغة نسبية
            48: (68.44, 53.57),  49: (75.04, 53.57),  # ضريبة الأرباح
            50: (68.44, 55.34),  51: (75.02, 55.35),  # صافي القيمة
            # ══ التفقيط ═════════════════════════════════════════════════
            52: ( 9.19, 57.29),# الصافي بالكلام
            # ══ سنة الإقرار ══════════════════════════════════════════════
            53: (84.01, 58.17),  # في سنة
            76: (91.19, 57.89),  # في — يوم-شهر
            # ══ توقيعات قسم ب ════════════════════════════════════════════
            # 54 محذوف — التاريخ مقسم على حقلي 76 (يوم-شهر) و 53 (رقم السنة)
            55: ( 6.83, 61.92),  # مراقب الحسابات
            56: ( 6.83, 64.44),  # رئيس الحسابات
            57: (56.68, 65.21),  # رقم حساب البنك
            58: (31.04, 67.07),  # بتاريخ
            59: ( 6.83, 73.13),  # رئيس المصلحة
            # ══ قسم ج — المراجعة ══════════════════════════════════════════
            60: (87.54, 77.59),  # تاريخ الختم ج
            61: (49.93, 70.73),  # قيد في سجل 55
            62: (55.45, 72.21),  # في سنة (روجع)
            63: (63.68, 72.33),  # تاريخ المراجعة
