...
class Form50PrintLayer(models.Model):
    ...
    def _form50_positions(self):
        ...
        return {
            ...
            # data area y=264-505px → 4 equal rows each ~60px tall
            # R1 center=294px(16.8%), R2=354px(20.2%), R3=414px(23.6%), R4=474px(27.0%)
            # جملة center=524px(29.9%)
            12: (82.0, 15.1),  13: (75.6, 15.1),  14: (67.5, 15.1),  15: (60.9, 15.1),
            16: (82.0, 19.0),  17: (75.6, 19.0),  18: (67.5, 19.0),  19: (60.9, 19.0),
            20: (82.0, 22.9),  21: (75.6, 22.9),  22: (67.5, 22.9),  23: (60.9, 22.9),
            24: (82.0, 26.8),  25: (75.6, 26.8),  26: (67.5, 26.8),  27: (60.9, 26.8),
            28: (67.5, 29.9),  29: (60.9, 29.9),  # الجملة
            ...
            # ── الاستقطاعات ───────────────────────────────────────────────────
            # data boxes y=956-1006px center=55.93%; رسم الدمغة y=1007-1019px center=57.75%
            42: (13.3, 55.9),   # دمغة عادية — جنيه
            43: (19.5, 55.9),   # دمغة عادية — قرش
            44: (34.0, 55.9),   # دمغة إضافية — جنيه
            45: (40.2, 55.9),   # دمغة إضافية — قرش
            46: (55.1, 55.9),   # دمغة نسبية — جنيه
            47: (59.7, 55.9),   # دمغة نسبية — قرش
            48: (19.0, 57.8),   # رسم الدمغة — جنيه  y=1007-1019px center≈57.75%
            49: (37.3, 57.8),   # رسم الدمغة — قرش

            # ── صافي القيمة والتفقيط ──────────────────────────────────────────
            # صافي row y=1032-1067px center=59.83%; التفقيط y≈1067-1094px center=61.6%
            50: (61.3, 59.8),   # صافي — جنيه
            51: (36.9, 59.8),   # صافي — قرش
            52: ( 3.0, 61.6),   # التفقيط بالكلام (wide text — start from left edge)

            # ── الإقرار ────────────────────────────────────────────────────────
            # between التفقيط y≈1094px and major line y=1209px; center≈67.5%
            53: (49.2, 67.5),   # في سنة
