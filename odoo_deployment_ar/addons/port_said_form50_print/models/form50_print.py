...
class Form50PrintLayer(models.Model):
    ...
    def _form50_positions(self):
        ...
        return {
            ...
            1:  (82.00,  9.66),  # رقم المسلسل  (v9: -3.44 LTR seq offset)
            2:  (85.74, 16.26),  # تاريخ الورود  (v9: -2.70 LTR date offset)
            ...
            31: (62.2, 32.1),   # تقييد في السجل رقم  (v9: -3.5 LTR seq offset)
            32: (77.0, 32.1),   # التاريخ              (v9: -2.7 LTR date offset)
            ...
            54: (58.2, 65.5),   # تاريخ العلامة    (v9: -2.7 LTR date offset)
            ...
            58: (64.0, 73.0),   # بتاريخ           (v9: -2.7 LTR date offset)
            59: (21.0, 73.0),   # رئيس المصلحة    underline center=21.0% @ y=73.0%
            60: (88.7, 73.0),   # الشتمذ ج         (v9: -2.7 LTR date offset)
            ...
            61: (46.0, 76.5),   # قيد في سجل رقم 55  (v9: -3.6 LTR seq offset)
            62: (21.9, 76.5),   # روجع في — سنة       @ y=76.5%
            63: (56.7, 76.5),   # روجع في — تاريخ     (v9: -2.7 LTR date offset)
            ...
            # ── قسم د ─────────────────────────────────────────────────────────
            # Row 1 (y=85.3%): blanks at x=19.4%, 24.4%, 28.3%, 39%, 73%
            # Row 2 (y=86.9%): blanks at x=62.2%, 65.7-70.4%, 94.4%
            # Row 3 (y=88.5%): blanks at x=41.1-44.5%, 46.1-49.4%
            # v9: complete remapping based on pixel underline analysis
            70: (91.7, 86.9),   # تاريخ الشتمذ          stamp circle area @ Row2 right (v9)
            71: (69.5, 85.3),   # رقم القيد دفتر 224   Row1 x=73% -3.5 LTR (v9)
            72: (24.4, 85.3),   # إمضاء الكاتب          Row1 x=24.4% (v9)
            73: (62.2, 86.9),   # إمضاء الشطب           Row2 x=62.2% (v9)
            74: (64.0, 86.9),   # رقم أمر الدفع         Row2 x=68% -4 LTR (v9)
            75: (39.0, 85.3),   # اسم المستفيد/الشيك    Row1 x=39% (v9)
        }
