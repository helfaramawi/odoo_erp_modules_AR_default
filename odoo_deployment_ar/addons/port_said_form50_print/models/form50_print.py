...
class Form50PrintLayer(models.Model):
    ...
    def _form50_positions(self):
        ...
        return {
            ...
            40: (68.44, 47.74),  41: (75.03, 47.74),  # إجمالي الأصل
            42: (68.44, 50.23),  43: (75.03, 50.23),  # دمغة عادية
            44: (68.44, 52.29),  45: (75.03, 52.29),  # دمغة إضافية
            46: (68.44, 54.24),  47: (75.03, 54.24),  # دمغة نسبية
            48: (68.44, 56.28),  49: (75.04, 56.28),  # ضريبة الأرباح
