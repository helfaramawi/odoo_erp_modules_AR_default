...
class UATDataGenerator(models.AbstractModel):
    ...
    def _generate_uat_scenarios(self):
        ...
        scenarios = [
            ...
            # ═══════════════════════════════════════════════════════════════
            ('PAY-001', 'استلام أمر دفع من الخزينة', 'payment', 'أوامر الدفع',
             ...
             'محاسب', 'pending'),
            ('PAY-002', 'قيد أمر الدفع في دفتر 224', 'payment', 'أوامر الدفع',
             'وجود أمر دفع مستلم',
             ...
             'محاسب', 'pending'),
            ('PAY-003', 'تحصيل أمر الدفع (إيداع بنك)', 'payment', 'أوامر الدفع',
             'وجود أمر دفع مسجل',
             ...
             'محاسب', 'pending'),
            ('PAY-004', 'إلغاء أمر دفع ومبرراته', 'payment', 'أوامر الدفع',
             'وجود أمر دفع في مرحلة المسودة',
             '1. افتح أمر الدفع\n2. اضغط "إلغاء"\n3. أدخل سبب الإلغاء',
             'يُلغى أمر الدفع ويُسجّل السبب في السجل',
             f'{UAT_BATCH} - أمر دفع ملغي',
             'مدير مالي', 'pending'),
            ('PAY-005', 'تقرير أوامر الدفع حسب الحالة', 'payment', 'أوامر الدفع',
             ...
             'مدير مالي', 'pending'),
            ('PAY-006', 'مطابقة أمر الدفع مع الشيك', 'payment', 'أوامر الدفع',
            ...
            ('CHQ-003', 'تتبع حالة الشيك (صُرف / لم يُصرف)', 'cheques', 'الشيكات',
             ...
             'وحدة أوامر الدفع والشيكات',
             'مدير مالي', 'pending'),
            ('CHQ-004', 'إلغاء شيك وإعادة الرقم', 'cheques', 'الشيكات',
             'وجود شيك لم يُسلّم للمستفيد',
             '1. افتح الشيك\n2. اضغط "إلغاء"\n3. أدخل سبب الإلغاء',
             'يُلغى الشيك ويُعاد الرقم لمجموعة المتاحة',
             'وحدة أوامر الدفع والشيكات',
             'محاسب', 'pending'),
            ('CHQ-005', 'كشف نقدي يومي', 'cheques', 'الشيكات',
            ...
            # ═══════════════════════════════════════════════════════════════
            ('BGU-001', 'استلام خطاب ضمان جديد', 'bank_guarantee', 'الضمانات البنكية',
            ...
            ('BGU-002', 'تنبيه انتهاء صلاحية الضمان', 'bank_guarantee', 'الضمانات البنكية',
             'وجود ضمان بنكي قريب الانتهاء (30 يوم)',
             '1. افتح لوحة القيادة\n2. لاحظ تنبيهات الضمانات',
             'يظهر تنبيه برتقالي للضمانات التي تنتهي خلال 30 يوماً',
             f'{UAT_BATCH} - ضمان بنكي نشط - عقد صيانة طريق',
             'مدير مالي', 'pending'),
            ('BGU-003', 'الإفراج عن خطاب ضمان بعد انتهاء العقد', 'bank_guarantee', 'الضمانات البنكية',
             ...
             'مدير مالي', 'pending'),
            ('BGU-004', 'مصادرة ضمان لعقد مخالف', 'bank_guarantee', 'الضمانات البنكية',
